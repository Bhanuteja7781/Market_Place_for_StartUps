    ...
    return (
        <>
            ...
            <div className="rethink relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                {/* Headline */}
                <h1 className="text-4xl md:text-6xl font-semibold max-w-3xl text-center mt-4 leading-tight">
                    Discover & Fund <span className="relative bg-gradient-to-r from-purple-700 to-[#764de1] bg-clip-text text-transparent">
                        Innovative
                    ...
                    </span> <span className='relative bg-gradient-to-r from-[#764de1] to-indigo-600 bg-clip-text text-transparent'>Startups</span>
                </h1>
