        ...
        <div className={`${showFilterPhone ? "max-sm:fixed" : "max-sm:hidden"} max-sm:inset-0 z-100 max-sm:h-screen max-sm:overflow-scroll bg-white rounded-lg shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-[300px]`}>
            <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 text-gray-700">
                        ...
                        <h3 className="font-semibold">Startup Filters</h3>
                    </div>
            ...
            <div className="p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar">
                ...
                <div className="flex items-center justify-between">
                    <input
                        type="text"
                        placeholder="Search startups by name, industry, market, etc."
                ...
                <div>
                    <button onClick={() => toggleSection("platform")} className="flex items-center justify-between w-full mb-3">
                        <label className="text-sm font-medium text-gray-800">Startup Type</label>
                ...
                <div>
                    <button onClick={() => toggleSection("price")} className="flex items-center justify-between w-full mb-3">
                        <label className="text-sm font-medium text-gray-800">Funding Goal</label>
                ...
                <div>
                    <button onClick={() => toggleSection("followers")} className="flex items-center justify-between w-full mb-3">
                        <label className="text-sm font-medium text-gray-800">Minimum Investor Interest</label>
                    ...
                    {expandedSections.followers && (
                        ...
                        >
                            ...
                            <option value="1000">1K+ interested</option>
                            <option value="10000">10K+ interested</option>
                            <option value="50000">50K+ interested</option>
                            <option value="100000">100K+ interested</option>
                            <option value="500000">500K+ interested</option>
                            <option value="1000000">1M+ interested</option>
                        </select>
                    )}
                </div>
                ...
                <div>
                    <button onClick={() => toggleSection("status")} className="flex items-center justify-between w-full mb-3">
                        <label className="text-sm font-medium text-gray-800">Startup Status</label>
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center space-x-2 cursor-pointer">
                                ...
                                <span className="text-sm text-gray-700">
                                    Legally registered startups only
                                </span>
                            </label>
                            <label className="flex items-center space-x-2 cursor-pointer">
                                <input
                                ...
                                />
                                <span className="text-sm text-gray-700">
                                    Revenue-generating startups only
                                </span>
                            </label>
                        </div>
                    )}
