    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
                <StatCard title='Total Startups Listed' value={userListings.length} icon={<Eye className='size-6 text-indigo-600' />} color='indigo' />
                <StatCard title='Active Startups' value={activeListings} icon={<CheckCircle className='size-6 text-green-600' />} color='green' />
                <StatCard title='Funded Startups' value={soldListings} icon={<TrendingUp className='size-6 text-indigo-600' />} color='indigo' />
                <StatCard title='Total Capital Raised' value={`${currency}${totalValue.toLocaleString()}`} icon={<DollarSign className='size-6 text-yellow-600' />} color='yellow' />
            </div>
            ...
            {userListings.length === 0 ? (
                <div className='bg-white rounded-lg border border-gray-200 p-16 text-center'>
                    ...
                    <h3 className='text-xl font-medium text-gray-800 mb-2'>No startups listed yet</h3>
                    <p className='text-gray-600 mb-6'>Start by adding your first startup</p>
